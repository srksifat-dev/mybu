...
class FacultyOfBioScience extends StatelessWidget {
  const FacultyOfBioScience({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var departments = FacultyRepository.faculties[1].departments;
