...
//   );
//   runApp(HomePage(notificationAppLaunchDetails));
// }
...
// int i = 0;
// List<int> timesForRouteOne = [15, 30, 10];
...
//   //     FlutterBackgroundService.setAsForegroundService();
//   //   });
...
//   //     await showProgressNotification(20).then((_) {
//   //       i++;
//   //     }).then((_) async {
...
//     print("start notification");
//     while (i <= (timesForRouteOne.length - 1)) {
//       await showProgressNotification(timesForRouteOne[i]).then((_) {
//         i++;
//       }).then((_) async {
//         if (i == timesForRouteOne.length) {
//           await cancelLastNotifications(1);
...
//                           await showProgressNotification(time).then((_) {
...
//   //       tz.TZDateTime(tz.local, now.year, now.month, now.day, 00, 25);
...
//   Future<void> showProgressNotification(int maxProgress) async {
//     id++;
