...
class FacultyOfArtsAndHumanities extends StatelessWidget {
  const FacultyOfArtsAndHumanities({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var departments = FacultyRepository.faculties[4].departments;
