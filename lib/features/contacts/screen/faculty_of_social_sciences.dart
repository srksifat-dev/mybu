...
class FacultyOfSocialScience extends StatelessWidget {
  const FacultyOfSocialScience({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var departments = FacultyRepository.faculties[3].departments;
