              ...
              FlutterSwitch(
                ...
                onToggle: (val) {
                  ...
                  if (val) {
                    ...
                    mySnackbar(context, "Notification On for Route Three");
                  } else {
                      ...
                      indicator: ElasticIn(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                              color: Theme.of(context).brightness == Brightness.dark ? AppColors.kLightGray : AppColors.kDeepBlue,
                          ...
                          child: routeThree[index].minute == 00
                              ? "${routeThree[index].hour! > 12 ? routeThree[index].hour! - 12 : routeThree[index].hour} : ${routeThree[index].minute}0 ${routeThree[index].hour! >= 12 ? 'pm' : 'am'}"
                                  .text
                                  .size(10)
                                  .color(Theme.of(context).brightness == Brightness.light ? AppColors.kLightGray : AppColors.kDeepBlue)
                                  .bold
                                  .makeCentered()
